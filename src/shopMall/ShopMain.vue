...
<div class="main">
    ...
    <div class="menu">
        <div @click="_goUrl('/homePage')" class="menu-item" :class="_isActive('首页')">
            <i class="fa fa-home" ></i>  
            <span class="menu-item-text">首页</span>
        </div>
        <div @click="_goUrl('/category')" class="menu-item" :class="_isActive('分类')">
            <i class="fa fa-th-large" ></i>  
            <span class="menu-item-text" >分类</span>
        </div>
        <div @click="_goUrl('/cart')" class="menu-item" :class="_isActive('购物车')">
             <i class="fa fa-shopping-cart" ></i>  
            <span class="menu-item-text">购物车</span>
        </div>
        <div @click="_goUrl('/userInfo')" class="menu-item" :class="_isActive('我的')">
